...
import goldImg from "../../../img/quest-perform/quest-complete/quest-complete__gold.png";
import fameImg from "../../../img/quest-perform/quest-complete/quest-complete__star.png";
